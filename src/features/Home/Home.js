...
export function Home() {
  return (
    <>
      <div>
        <div>
          <ul className=" list-disc inline-flex space-x-5  font-bold mr-20 float-right">
        ...
        <div className="  ml-2 mt-8 mr-4 grid grid-cols-3">
          <img
          ...
          <img
            className="w-96 md:h-60 ml-16 animate-[bounce_2s]"
